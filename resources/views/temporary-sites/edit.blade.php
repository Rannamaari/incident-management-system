...
@section('header')
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            ...
            <p class="mt-2 text-lg text-gray-600 dark:text-gray-400 font-medium">Update temporary site information</p>
        </div>
                ...
                <div class="border-b border-gray-200 dark:border-gray-700/50 bg-gradient-to-r from-slate-50/80 to-white/60 px-6 py-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-gray-400">Update the fields below to edit the temporary site</p>
                        </div>
                    </div>
                </div>
