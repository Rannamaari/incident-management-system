...
@section('header')
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            ...
            <p class="mt-2 text-lg text-gray-600 font-medium">Add a new temporary site to the master list</p>
        </div>
                ...
                <div class="border-b border-gray-200/50 bg-gradient-to-r from-slate-50/80 to-white/60 px-6 py-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600">Fill in the details below to create a new temporary site</p>
                        </div>
                    </div>
                </div>
