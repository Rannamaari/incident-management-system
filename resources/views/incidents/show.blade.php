    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <h1 class="text-2xl lg:text-3xl font-bold tracking-tight bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">
            ...
            @if(auth()->user()->canEditIncidents())
                ...
                @if($incident->status !== 'Closed')
                    <button type="button" id="close-incident-btn"
                        class="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-red-600 to-red-700 px-5 py-2.5 text-white shadow-lg hover:from-red-700 hover:to-red-800 focus:outline-none focus:ring-2 focus:ring-red-500/30 transition-all duration-300 transform hover:-translate-y-0.5">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div class="lg:col-span-2">
                    <!-- Incident Details -->
                    <div class="overflow-hidden rounded-3xl border border-gray-100/50 bg-white/80 backdrop-blur-sm shadow-xl mb-8">
                        ...
                        <div class="p-6">
                            <dl class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Affected Services</dt>
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Outage Category</dt>
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Resolution Team</dt>
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Work Time</dt>
                                ...
                                <div class="sm:col-span-2">
                                    <dt class="text-sm font-medium text-gray-500">Reason for Delay</dt>
                                ...
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">PIR/RCA No</dt>
                ...
                <div class="lg:col-span-1">
                    <!-- SLA Information -->
                    <div class="rounded-3xl border border-gray-100/50 bg-white/80 backdrop-blur-sm p-6 shadow-xl mb-8">
                        <h4 class="text-lg font-semibold text-gray-900 mb-4">SLA Information</h4>
                        <dl class="space-y-3">
                            <div>
                                <dt class="text-sm font-medium text-gray-500">SLA Target</dt>
                                <dd class="text-sm text-gray-900">{{ $incident->sla_minutes / 60 }} hours</dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Status</dt>
                                <dd class="text-sm">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $incident->getSlaColorClass() }}">
                    ...
                    <!-- RCA Information -->
                    <div class="rounded-3xl border border-gray-100/50 bg-white/80 backdrop-blur-sm p-6 shadow-xl mb-8">
                        <h4 class="text-lg font-semibold text-gray-900 mb-4">RCA Status</h4>
                        <div class="space-y-3">
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Required</dt>
                                <dd class="text-sm">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $incident->getRcaColorClass() }}">
                            ...
                            <div>
                                <dt class="text-sm font-medium text-gray-500 mb-2">RCA Files</dt>
                                <div class="space-y-2">
                                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <p class="text-sm font-medium text-gray-900">RCA Document</p>
                                                <p class="text-xs text-gray-500">{{ $incident->rca_received_at ? $incident->rca_received_at->format('M j, Y') : 'Unknown date' }}</p>
                                            </div>
                                        </div>
                    ...
                    <div class="rounded-3xl border border-gray-100/50 bg-white/80 backdrop-blur-sm p-6 shadow-xl">
                        ...
                        <dl class="space-y-3">
                            <div class="flex justify-between">
                                ...
                                <dd class="text-sm text-gray-900">{{ $incident->created_at->format('M j, Y') }}</dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">Updated</dt>
                                <dd class="text-sm text-gray-900">{{ $incident->updated_at->diffForHumans() }}</dd>
                            </div>
                            @if($incident->logs->count() > 0)
                            <div class="flex justify-between">
                                <dt class="text-sm text-gray-500">Log Entries</dt>
                                <dd class="text-sm text-gray-900">{{ $incident->logs->count() }}</dd>
                            </div>
                            @endif
                        </dl>
                    </div>
            ...
            <div class="relative inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
                <form action="{{ route('incidents.update', $incident) }}" method="POST" id="close-incident-form">
                    ...
                    <div class="mt-5 space-y-4">
                        ...
                        <!-- Resolved At -->
                        <div>
                            <label for="modal_resolved_at" class="block text-sm font-medium text-gray-700">
                        ...
                        <div id="conditional-fields" class="space-y-4">
                            ...
                            <div id="travel-time-field" class="hidden">
                                <label for="modal_travel_time" class="block text-sm font-medium text-gray-700">
                            ...
                            <div id="work-time-field" class="hidden">
                                <label for="modal_work_time" class="block text-sm font-medium text-gray-700">
                            ...
                            <div id="delay-reason-field" class="hidden">
                                <label for="modal_delay_reason" class="block text-sm font-medium text-gray-700">
