...
@section('header')
    <!-- Hero -->
    <div class="-mx-4 sm:-mx-6 lg:-mx-8 bg-gradient-to-br from-slate-50 via-white to-indigo-50/50 px-4 sm:px-6 lg:px-8 py-8 border-b border-gray-200 dark:border-gray-700/30">
        <div class="mx-auto max-w-7xl">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="mt-2 text-lg text-gray-600 dark:text-gray-400 font-medium">View and manage your account information</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="py-6 lg:py-8">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            @if(session('status') === 'profile-updated')
                <div class="mb-6 rounded-2xl bg-gradient-to-r from-green-50 to-green-100 border border-green-200 dark:border-green-700 p-4">
                    <div class="flex items-center gap-3">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="lg:col-span-1">
                    <div class="rounded-3xl border border-gray-100 dark:border-gray-700/50 bg-white/90 backdrop-blur-sm p-6 shadow-lg">
                        <div class="text-center">
                            ...
                            <!-- User Info -->
                            <h2 class="text-2xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-1">{{ $user->name }}</h2>
                ...
                <div class="lg:col-span-2">
                    <div class="rounded-3xl border border-gray-100 dark:border-gray-700/50 bg-white/90 backdrop-blur-sm p-6 lg:p-8 shadow-lg">
                        <h3 class="text-xl font-heading font-bold text-gray-900 dark:text-gray-100 mb-6">Account Information</h3>

                        <div class="space-y-6">
                            <!-- Name -->
                            <div>
                                <label class="block text-sm font-heading font-semibold text-gray-700 dark:text-gray-300 mb-2">Full Name</label>
                                <div class="rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-3 text-gray-900 dark:text-gray-100">
                                    {{ $user->name }}
                                </div>
                            </div>
                            ...
                            <!-- Email -->
                            <div>
                                <label class="block text-sm font-heading font-semibold text-gray-700 dark:text-gray-300 mb-2">Email Address</label>
                                <div class="rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-3 text-gray-900 dark:text-gray-100">
                                    {{ $user->email }}
                                </div>
                            </div>
                            ...
                            <!-- Role -->
                            <div>
                                <label class="block text-sm font-heading font-semibold text-gray-700 dark:text-gray-300 mb-2">Role</label>
                                <div class="rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-3 text-gray-900 dark:text-gray-100">
                                    {{ $user->getRoleDisplayName() }}
                                </div>
                            </div>
                            ...
                            <!-- Permissions -->
                            <div>
                                <label class="block text-sm font-heading font-semibold text-gray-700 dark:text-gray-300 mb-3">Permissions</label>
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <!-- View Incidents -->
                                    <div class="flex items-center gap-2 rounded-xl bg-green-50 border border-green-200 dark:border-green-700 px-4 py-2.5">
                                        <svg class="h-5 w-5 text-green-600" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    ...
                                    @else
                                        <div class="flex items-center gap-2 rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-2.5">
                                            <svg class="h-5 w-5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />
                                            </svg>
                                            <span class="text-sm font-heading font-medium text-gray-500 dark:text-gray-400">Edit Incidents</span>
                                        </div>
                                    @endif
                                    ...
                                    @else
                                        <div class="flex items-center gap-2 rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-2.5">
                                            ...
                                            <span class="text-sm font-heading font-medium text-gray-500 dark:text-gray-400">Delete Incidents</span>
                                        </div>
                                    @endif
                                    ...
                                    @else
                                        <div class="flex items-center gap-2 rounded-xl bg-gray-50 border border-gray-200 dark:border-gray-700 px-4 py-2.5">
                                            ...
                                            <span class="text-sm font-heading font-medium text-gray-500 dark:text-gray-400">Manage Users</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <!-- Info Note -->
                            <div class="rounded-xl bg-blue-50 border border-blue-200 dark:border-blue-700 p-4">
