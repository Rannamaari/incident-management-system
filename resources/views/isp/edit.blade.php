...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
    <div class="mb-6">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Edit ISP Link</h1>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Update ISP link information and escalation contacts</p>
    </div>

    <form method="POST" action="{{ route('isp.update', $ispLink) }}" x-data="ispForm()" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white dark:bg-slate-900 border border-gray-400 dark:border-white/10 rounded shadow-sm dark:shadow-black/40 p-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="isp_name" id="isp_name" required value="{{ old('isp_name', $ispLink->isp_name) }}"
                ...
                <div>
                    ...
                    <input type="text" name="circuit_id" id="circuit_id" required value="{{ old('circuit_id', $ispLink->circuit_id) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
                    @error('circuit_id')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select name="link_type" id="link_type" required
                        ...
                        @foreach(\App\Models\IspLink::LINK_TYPES as $type)
                            <option value="{{ $type }}" {{ old('link_type', $ispLink->link_type) == $type ? 'selected' : '' }}>{{ $type }}</option>
                        @endforeach
                    </select>
                    @error('link_type')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                ...
                <div>
                    ...
                    <select name="status" id="status" required
                        ...
                        @foreach(\App\Models\IspLink::STATUSES as $status)
                            <option value="{{ $status }}" {{ old('status', $ispLink->status) == $status ? 'selected' : '' }}>{{ $status }}</option>
                        @endforeach
                    </select>
                    @error('status')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="total_capacity_gbps" id="total_capacity_gbps" 
                           ...
                           step="0.01" min="0" required value="{{ old('total_capacity_gbps', $ispLink->total_capacity_gbps) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
                ...
                <div>
                    ...
                    <input type="number" name="current_capacity_gbps" id="current_capacity_gbps" 
                           ...
                           step="0.01" min="0" required value="{{ old('current_capacity_gbps', $ispLink->current_capacity_gbps) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
        ...
        <div class="bg-white dark:bg-slate-900 border border-gray-400 dark:border-white/10 rounded shadow-sm dark:shadow-black/40 p-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="prtg_sensor_id" id="prtg_sensor_id" value="{{ old('prtg_sensor_id', $ispLink->prtg_sensor_id) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
                ...
                <div>
                    ...
                    <input type="url" name="prtg_api_endpoint" id="prtg_api_endpoint" value="{{ old('prtg_api_endpoint', $ispLink->prtg_api_endpoint) }}"
                           placeholder="https://..."
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
        ...
        <div class="bg-white dark:bg-slate-900 border border-gray-400 dark:border-white/10 rounded shadow-sm dark:shadow-black/40 p-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="location_a" id="location_a" required value="{{ old('location_a', $ispLink->location_a) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
                    @error('location_a')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" name="location_b" id="location_b" required value="{{ old('location_b', $ispLink->location_b) }}"
                           class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">
                    @error('location_b')
                        <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                    @enderror
        ...
        <div class="bg-white dark:bg-slate-900 border border-gray-400 dark:border-white/10 rounded shadow-sm dark:shadow-black/40 p-5">
            ...
            <div>
                ...
                <textarea name="notes" id="notes" rows="4"
                          class="w-full px-3 py-2 border border-gray-300 dark:border-white/10 rounded-lg shadow-sm bg-white dark:bg-slate-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:focus:ring-indigo-400 focus:border-transparent text-sm">{{ old('notes', $ispLink->notes) }}</textarea>
                @error('notes')
                    <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
...
function ispForm() {
    return {
        totalCapacity: {{ old('total_capacity_gbps', $ispLink->total_capacity_gbps) }},
        currentCapacity: {{ old('current_capacity_gbps', $ispLink->current_capacity_gbps) }},
        lostCapacity: 0,
        availability: 0,
        contacts: [
            @foreach($ispLink->escalationContacts as $contact)
            {
                escalation_level: '{{ old("escalation_contacts.$loop->index.escalation_level", $contact->escalation_level) }}',
                contact_name: '{{ old("escalation_contacts.$loop->index.contact_name", $contact->contact_name) }}',
                contact_phone: '{{ old("escalation_contacts.$loop->index.contact_phone", $contact->contact_phone) }}',
                contact_email: '{{ old("escalation_contacts.$loop->index.contact_email", $contact->contact_email ?? "") }}'
            },
            @endforeach
        ],
        init() {
