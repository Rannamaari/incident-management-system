...
@section('header')
    <div class="flex flex-col gap-3 sm:gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
            ...
            <p class="mt-1 sm:mt-2 text-sm sm:text-base lg:text-lg text-gray-600 font-medium">Fixed Broadband service locations</p>
        </div>
                ...
                <form method="GET" action="{{ route('fbb-islands.index') }}" class="space-y-4">
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}"
                            ...
                            class="w-full rounded-xl sm:rounded-2xl border border-gray-300/50 pl-12 pr-4 py-3 sm:py-3.5 text-sm sm:text-base shadow-sm focus:border-purple-600 focus:ring-2 focus:ring-purple-600/20 touch-manipulation">
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <select name="technology" class="rounded-xl border border-gray-300/50 px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base touch-manipulation">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('fbb-islands.index') }}" class="flex-1 sm:flex-none rounded-xl border-2 border-gray-300 bg-white px-6 py-3 text-sm sm:text-base font-heading font-semibold text-gray-700 text-center hover:bg-gray-50 transition-colors touch-manipulation">
                            Clear
                        </a>
                    </div>
                </form>
            ...
            <div class="lg:hidden space-y-4">
                    ...
                    <div class="rounded-2xl border border-gray-100/50 bg-white/80 backdrop-blur-sm shadow-lg p-4 hover:shadow-xl transition-shadow">
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                ...
                                <p class="text-sm text-gray-600 mt-1">{{ $island->technology }}</p>
                            </div>
                ...
                @empty
                    <div class="text-center py-12 rounded-2xl border border-gray-200 bg-white/50">
                        ...
                        <p class="mt-4 text-base font-medium text-gray-900">No FBB islands found</p>
                    </div>
                @endforelse
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200/50">
                    <thead class="bg-gradient-to-r from-slate-50/80 to-white/60">
                        <tr>
                            ...
                            <th class="px-4 py-4 text-left text-xs font-heading font-semibold text-gray-700 uppercase">Island Name</th>
                            <th class="px-4 py-4 text-left text-xs font-heading font-semibold text-gray-700 uppercase">Technology</th>
                    ...
                    <tbody class="divide-y divide-gray-200/30 bg-white/60">
                        @forelse($fbbIslands as $island)
                            <tr class="hover:bg-purple-50/30 transition-colors">
                                <td class="px-4 py-4 text-sm font-semibold text-gray-900">{{ $island->region->code }}</td>
                                <td class="px-4 py-4">
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-12 text-center text-gray-500">No FBB islands found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
