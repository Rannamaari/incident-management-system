...
@section('header')
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="mt-2 text-lg text-gray-600 dark:text-gray-400">{{ $site->site_code }} - {{ $site->display_name }}</p>
        </div>
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('sites.update', $site) }}"
                ...
                <div class="overflow-hidden rounded-3xl border bg-white dark:bg-gray-800 shadow-xl p-8">
                    <h3 class="text-lg font-heading font-semibold text-gray-900 dark:text-gray-100 mb-6">Site Information</h3>

                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Site Code</label>
                            <p class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $site->site_code }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Site Number</label>
                            <p class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $site->site_number }}</p>
                        </div>

                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Display Name</label>
                            <p class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $site->display_name }}</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Region</label>
                            <p class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $site->region->name }} ({{ $site->region->code }})</p>
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1">Site Name</label>
                            <p class="text-base font-semibold text-gray-900 dark:text-gray-100">{{ $site->site_name ?: 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <!-- Site Settings -->
                <div class="overflow-hidden rounded-3xl border bg-white dark:bg-gray-800 shadow-xl p-8">
                    <h3 class="text-lg font-heading font-semibold text-gray-900 dark:text-gray-100 mb-6">Site Settings</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-gray-50">
                            ...
                            <label for="is_active" class="flex-1 cursor-pointer">
                                <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">Active Site</span>
                                <span class="text-xs text-gray-500 dark:text-gray-400">Enable this site for monitoring and incident tracking. Inactive sites are hidden from incident creation.</span>
                            </label>
                        </div>
                        ...
                        <div class="flex items-center gap-3 p-4 rounded-xl bg-blue-50">
                            ...
                            <label for="is_link_site" class="flex-1 cursor-pointer">
                                <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">Link Site</span>
                                <span class="text-xs text-gray-500 dark:text-gray-400">This site is used as a network link/relay point</span>
                            </label>
                        </div>

                        <!-- Transmission / Backhaul -->
                        <div class="p-4 rounded-xl bg-gray-50">
                            <label for="transmission_backhaul" class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
                                Transmission / Backhaul
                            </label>
                            <input type="text"
                                   ...
                                   class="w-full rounded-lg border-gray-300 dark:border-gray-600 shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:focus:ring-blue-400"
                                   placeholder="e.g., Fiber, Microwave, Satellite">
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Specify the backhaul technology for this site</p>
                        </div>
                        ...
                        <div class="p-4 rounded-xl bg-gray-50">
                            ...
                            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Any additional information or special notes about this site</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="overflow-hidden rounded-3xl border bg-white dark:bg-gray-800 shadow-xl p-8">
                    <h3 class="text-lg font-heading font-semibold text-gray-900 dark:text-gray-100 mb-6">Site Type & Hub Connections</h3>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label class="flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-colors"
                                ...
                                <div class="flex-1">
                                    <span class="text-sm font-bold text-gray-900 dark:text-gray-100">End Site</span>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Standard site that connects to hub sites for backhaul</p>
                                </div>
                            </label>
                            ...
                            <label class="flex items-start gap-3 p-4 rounded-xl border-2 cursor-pointer transition-colors"
                                ...
                                <input type="radio"
                                       ...
                                       class="mt-1 h-4 w-4 text-blue-600 border-gray-300 dark:border-gray-600 focus:ring-blue-500 dark:focus:ring-blue-400">
                                <div class="flex-1">
                                    <span class="text-sm font-bold text-gray-900 dark:text-gray-100">Hub Site</span>
                                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1">Central site that provides backhaul to multiple end sites</p>
                                </div>
                            </label>
                        </div>
                    ...
                    <div x-show="siteType === 'End Site'"
                        ...
                        @else
                            <div class="text-center py-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
                                <p class="text-sm text-gray-600 dark:text-gray-400">No hub sites available</p>
                            </div>
                        @endif
                    ...
                    <div x-show="siteType === 'Hub Site'"
                        ...
                        @if($site->connectedSites->count() > 0)
                            <div class="space-y-2">
                                @foreach($site->connectedSites as $connectedSite)
                                    <div class="flex items-center gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200 dark:border-blue-700">
                                        <svg class="h-5 w-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" />
                                        </svg>
                                        <div class="flex-1">
                                            <p class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $connectedSite->site_code }}</p>
                                            <p class="text-xs text-gray-600 dark:text-gray-400">{{ $connectedSite->display_name }}</p>
                                        </div>
                        ...
                        @else
                            <div class="text-center py-6 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
                                <p class="text-sm text-gray-600 dark:text-gray-400">No sites connected to this hub yet</p>
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">End sites can select this hub from their connection settings</p>
                            </div>
                        @endif
                ...
                <!-- Technologies -->
                <div class="overflow-hidden rounded-3xl border bg-white dark:bg-gray-800 shadow-xl p-8">
                    <h3 class="text-lg font-heading font-semibold text-gray-900 dark:text-gray-100 mb-6">Available Technologies</h3>

                    <div class="space-y-6">
                        <!-- Cellular Technologies -->
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Cellular Technologies</h4>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                @foreach($site->technologies->whereIn('technology', ['2G', '3G', '4G', '5G']) as $tech)
                                    <div class="flex items-center gap-2 p-3 rounded-lg border {{ $tech->is_active ? 'bg-green-50 border-green-200 dark:border-green-700' : 'bg-gray-50 border-gray-200 dark:border-gray-700' }}">
                                        <input type="checkbox"
                                               name="technologies[{{ $tech->id }}]"
                                               id="tech_{{ $tech->id }}"
                                               value="1"
                                               {{ $tech->is_active ? 'checked' : '' }}
                                               class="h-4 w-4 rounded border-gray-300 dark:border-gray-600 text-green-600 focus:ring-green-500 dark:focus:ring-green-400">
                                        <label for="tech_{{ $tech->id }}" class="text-sm font-medium text-gray-900 dark:text-gray-100 cursor-pointer">
                                            {{ $tech->technology }}
                                        </label>
                                    </div>
                                @endforeach
                        ...
                        <!-- Other Services -->
                        <div>
                            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Other Services</h4>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                @foreach($site->technologies->whereIn('technology', ['ILL', 'SIP', 'IPTV', 'NCIT']) as $tech)
                                    <div class="flex items-center gap-2 p-3 rounded-lg border {{ $tech->is_active ? 'bg-blue-50 border-blue-200 dark:border-blue-700' : 'bg-gray-50 border-gray-200 dark:border-gray-700' }}">
                                        <input type="checkbox"
                                               name="technologies[{{ $tech->id }}]"
                                               id="tech_{{ $tech->id }}"
                                               value="1"
                ...
                <div class="flex justify-end gap-3">
                    <a href="{{ route('sites.show', $site) }}"
                       class="inline-flex items-center gap-2 rounded-2xl border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-6 py-3 font-semibold text-gray-700 dark:text-gray-300 hover:bg-gray-50">
                        Cancel
                    </a>
                    <button type="submit"
